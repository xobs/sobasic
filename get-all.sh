...
components="Amplifiers/Comparators|Audio Products / Vibration Motors|Capacitors|Circuit Protection|Clock/Timing|Connectors|Crystals, Oscillators, Resonators|Data Acquisition|Development Boards & Tools|Diodes|Displays|Electronic Tools/Instruments/Consumables|Embedded Processors & Controllers|Filters|Global Sourcing Parts|Hardware/Fasteners/Sealing|Inductors, Coils, Chokes|Interface|IoT/Communication Modules|LED Drivers|Logic|Magnetic Sensors|Memory|Motor Driver ICs|Old Batch|Optocouplers & LEDs & Infrared|Optoelectronics|Optoisolators|Power Management (PMIC)|Power Management ICs|Power Modules|Relays|Resistors|RF And Wireless|Sensors|Signal Isolation Devices|Silicon Carbide (SiC) Devices|Switches|Transistors/Thyristors|Triode/MOS Tube/Transistor"
failed_components=""
